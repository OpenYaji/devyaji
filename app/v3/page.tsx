...
export default function V3Page() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0E0E10] text-[#E2E2E2] py-4 lg:py-6 px-2 font-sans selection:bg-blue-600 selection:text-white relative z-10">
        <div className="w-full grid grid-cols-1 lg:grid-cols-[260px_1fr_320px] gap-6">
        
        {/* ========================================================
            LEFT COLUMN (SIDEBAR)
        ======================================================== */}
        <aside className="bg-[#18181b] rounded-2xl p-6 flex flex-col h-full border border-white/5">
          <div className="flex flex-col items-center mb-8">
            <div className="w-20 h-20 rounded-full border-2 border-white/10 overflow-hidden mb-4 bg-zinc-800 p-1">
            ...
            <h2 className="text-[15px] font-bold text-white text-center leading-tight">
              John Rey<br />Bisnar Calipes
            </h2>
            <h1 className="text-2xl font-black text-blue-500 tracking-tight mt-1 mb-2">DEVYAJI</h1>
            <p className="text-[11px] text-zinc-400 font-medium">CTO @ SEEGLA | AI Engineer</p>

            <button className="w-full mt-6 bg-blue-600 hover:bg-blue-500 text-white font-semibold flex items-center justify-center gap-2 py-3 rounded-xl transition-all shadow-[0_0_15px_rgba(37,99,235,0.3)]">
          ...
          <div className="mt-8 pt-6 border-t border-white/5 relative z-50">
